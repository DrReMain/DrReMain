...
<Layout meta={meta}>
    ...
    这里注意不要双击图标去安装，而需要用java运行jar包的方式安装。具体如下
    ...
    ❯ sudo java -jar SetupSTM32CubeMX-6_6_1
    ```
    ...
    配置好openocd和stm32cubemx的位置，点击test通过就行
    ...
    openocd使用brew安装，所以都在brew的bin目录下。而stm32cubemx因为是通过java -jar安装的，我这里被安装到了当前用户家目录下
